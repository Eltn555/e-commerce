    ...
    <div class="intro-y box mt-5">
        ...
        <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10">
            <div>
                ...
                <div class="text-lg font-medium text-primary mt-2">{{ $sale->customer->name }}</div>
            </div>
            <div class="lg:text-right  lg:mt-0 lg:ml-auto">
                <div class="text-base text-slate-500">Sale Details</div>
                <div class="text-lg font-medium text-primary mt-2">
                    <div>
                        Sale Amount: {{ $sale->amount }}
                    </div>
                    <div>
                        {{ $sale->debt !== 0 ? 'Sale Debt: ' . $sale->debt : 'PAID'}}
                    </div>
                </div>
            </div>
        </div>
