...
<div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- END: Modal Header -->
            <form action="{{ route('admin.import.finances.store') }}" method="POST">
                @csrf
                <!-- BEGIN: Modal Body -->
                <div class="modal-body gap-4 gap-y-3">
                    <div class="">
                        <label for="customer_id" class="form-label">From</label>
                        <select class="tom-select w-full" id="customer_id" name="customer_id" required>
